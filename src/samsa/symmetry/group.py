...
from samsa.utils.array_checks import _array_in_list, _element_in_list
...
from samsa.utils.errors import custom_format_warning
...
class Group:
    ...
    def calculate_classes(self, store_data=False):
        ...
        while len(members) > 0:
            ...
            for h in element_list:
                ...
                if element_index[e_h] not in class_:
    ...
    def calculate_orbit(self, p0):
        ...
        permutations = [{} for _ in range(len(self.generators))]
...
class Orbit:
    ...
    def __init__(
        ...
        # Store original group generators
    ...
    def generators(self):
        """
        Generators of the space group written as permutations of the orbit
        elements.
        """
    ...
    def stabilizer_group(self, as_permutations=False):
        ...
        stabilizer_elements = [
            p.pointer_to_element(generators, skip_checks=True)
            for p in self.__stabilizers
        ]

        return Group(stabilizer_elements, filter_generators=True)
