...
samsa/database to symmetry objects defined in group_utils.py.
"""
...
class Database:
    ...
    def get_file_index(self):
        """
        Creates an index of .toml files in samsa/database.
        """
    ...
    def available_files(self):
        """
        Index of .toml files in samsa/database
        """
    ...
    def path_to_database(self):
        """
        Absolute path to samsa/database
        """
        return self.__path
